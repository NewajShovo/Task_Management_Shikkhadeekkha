...
// import { people, teams, getTeamById, type Person } from "@/lib/people";
...
export default function PeoplePage() {
  ...
  const filteredPeople = people.filter((person) => {
    const matchesSearch =
      (person.full_name?.toLowerCase() ?? "").includes(
  ...
  const peopleByTeams = teams.reduce((acc, team) => {
