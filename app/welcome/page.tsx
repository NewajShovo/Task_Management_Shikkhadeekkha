      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4">
            Welcome to{" "}
            <span className="text-blue-600">ShikkhaDeekhaTracker</span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            A comprehensive project management platform for teams to
            collaborate, track progress, and achieve their goals.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-400">
                Organize your projects, set deadlines, and monitor progress with
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-600 dark:text-gray-400">
                Comprehensive admin panel to manage users, create teams, and
        ...
        <div className="text-center">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Join thousands of teams already using Mondays to streamline their
